...
export function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (json.success) {
        setSuccess(true);
        gtagEvent('generate_lead', { method: 'web3forms' });
        form.reset();
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <div className="space-y-8 mb-12">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:87003000515" onClick={() => gtagEvent('click_phone')} className="text-white/60 font-light hover:text-primary transition-colors">8 700 300 0515</a>
                </div>
              </div>
            ...
            <Button
              ...
              onClick={() => { gtagEvent('click_whatsapp'); window.open('https://wa.me/77003000515', '_blank'); }}
            >
