      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-primary text-sm tracking-widest uppercase font-semibold mb-4">Свяжитесь с нами</h2>
            <h3 className="text-4xl md:text-5xl font-serif text-white mb-8">Обсудим ваш проект</h3>

            <p className="text-white/60 font-light mb-12 max-w-md">
              Строите новый бизнес-центр, отель или жилой комплекс? Наши инженеры готовы разработать оптимальное решение под любой объект.
            </p>
            ...
            <div className="space-y-8 mb-12">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:87003000515" className="text-white/60 font-light hover:text-primary transition-colors">
                    8 700 300 0515
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-white font-serif text-lg mb-1">Электронная почта</h4>
                  <a href="mailto:akor.yug@gmail.com" className="text-white/60 font-light hover:text-primary transition-colors">
                    akor.yug@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-white font-serif text-lg mb-1">Часы работы</h4>
                  <p className="text-white/60 font-light">Пн – Пт: 9:00 – 18:00 (UTC+5)</p>
                </div>
              </div>
            </div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="glass rounded-2xl p-8 lg:p-10 border border-white/10 relative"
          >
            <h4 className="text-2xl font-serif text-white mb-6">Отправить запрос</h4>
            ...
            {success ? (
              <div className="absolute inset-0 z-10 glass rounded-2xl flex flex-col items-center justify-center p-8 text-center animate-in fade-in zoom-in duration-500">
                ...
                <h5 className="text-2xl font-serif text-white mb-2">Заявка отправлена</h5>
                <p className="text-white/60">Спасибо за обращение. Наши инженеры свяжутся с вами в ближайшее время.</p>
              </div>
            ) : null}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-xs text-white/60 uppercase tracking-wider">Имя и фамилия</label>
                ...
                <div className="space-y-2">
                  <label className="text-xs text-white/60 uppercase tracking-wider">Компания / Организация</label>
                  <input required type="text" className="w-full bg-white/5 border border-white/10 rounded-lg h-12 px-4 text-white focus:outline-none focus:border-primary transition-colors" />
                </div>
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-xs text-white/60 uppercase tracking-wider">Телефон</label>
              ...
              <div className="space-y-2">
                <label className="text-xs text-white/60 uppercase tracking-wider">Описание проекта</label>
                <textarea required rows={4} placeholder="Расскажите об объекте, количестве этажей, типе оборудования..." className="w-full bg-white/5 border border-white/10 rounded-lg p-4 text-white focus:outline-none focus:border-primary transition-colors resize-none"></textarea>
              </div>
