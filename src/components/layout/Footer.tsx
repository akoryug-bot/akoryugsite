        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/60">
              ...
              <li className="flex gap-3 items-center">
                ...
                <a href="tel:87003000515" className="hover:text-primary transition-colors">8 700 300 0515</a>
              </li>
              <li className="flex gap-3 items-center">
          ...
          <div>
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              <a href="https://wa.me/77003000515" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-[#25D366] hover:text-[#128C7E] transition-colors">
