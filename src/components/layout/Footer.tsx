    ...
    <footer className="bg-[#070D15] pt-20 pb-10 border-t border-white/5">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white/60 text-sm leading-relaxed max-w-xs">
              Надёжный инжиниринговый партнёр на пересечении немецкой точности и казахстанского масштаба.
              Официальный партнёр TK Elevator и эксклюзивный представитель KOYO в Казахстане.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="text-white font-serif text-lg mb-6">Навигация</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-white font-serif text-lg mb-6">Контакты</h4>
            <ul className="space-y-4 text-sm text-white/60">
              <li className="flex gap-3">
                <MapPin className="w-5 h-5 text-primary shrink-0" />
                <span>Костанай, ул. Карбышева 12/7<br />Казахстан, 110000</span>
              </li>
              <li className="flex gap-3 items-center">
                ...
                <a href="tel:87003000515" className="hover:text-primary transition-colors">
                  8 700 300 0515
                </a>
              </li>
              <li className="flex gap-3 items-center">
                <Mail className="w-5 h-5 text-primary shrink-0" />
                <a href="mailto:akor.yug@gmail.com" className="hover:text-primary transition-colors">
                  akor.yug@gmail.com
                </a>
              </li>
              <li className="flex gap-3 items-center">
          ...
          {/* Office hours */}
          <div>
            <h4 className="text-white font-serif text-lg mb-6">Часы работы</h4>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-white/10 text-xs text-white/40">
          <p>&copy; {new Date().getFullYear()} ТОО «АКОР ЮГ». Все права защищены.</p>
